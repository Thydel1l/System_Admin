...
def stress_test():
    ...
    try:
        ...
        while time.time() - start_time < 120:  # Ejecutar pruebas durante 120 segundos
            try:
                # Consulta 1
            ...
            time.sleep(0.5)  # Reducir el tiempo de espera para aumentar la frecuencia de las consultas
...
num_threads = 10  # Incrementar el número de hilos para aumentar el estrés
threads = []
...
cpu_memory_pie = plt.figure(figsize=(8, 8))
